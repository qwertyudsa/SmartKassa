...
- [9. Планируемые улучшения](#9-планируемые-улучшения)
...
3. Доработка вида чека
4. Добавление более функциональных отчетов
5. Реализация импорта товаров из файла


### UI/UX:
1. Добавить темную тему
2. Реализовать поиск по штрих-коду
